...
1. [Оформление](#1.-оформление)
   * 1.1. [Базовый стандарт оформления кода](#11-базовый-стандарт-оформления-кода)
   * 1.2. [Строки](#12-строки)
   * 1.3. [Выравнивание присвоений переменных и элементов массива](#13-выравнивание-присвоений-переменных-и-элементов-массива)
   * 1.4. [Массивы](#14-массивы)
   * 1.5. [Последовательность вызовов (Chaining)](#15-последовательность-вызовов-chaining)
   * 1.6. [Выделение управляющих инструкций](#16-выделение-управляющих-инструкций)
2. [Документирование](#2-документирование)
   * 2.1. [Базовый стандарт для оформления документации в коде](#21-базовый-стандарт-для-оформления-документации-в-коде)
   * 2.2. [Дублирование типов в docblock](#22-дублирование-типов-в-docblock)
   * 2.3. [Массивы в docblock](#23-Массивы-в-docblock)
   * 2.4. [Неопределенные типы аргументов и возвращаемых результатов](#24-неопределенные-типы-аргументов-и-возвращаемых-результатов)
   * 2.6. [Свойства](#26-свойства)
   * 2.7. [Методы и функции](#27-методы-и-функции)
3. [Объявление констант, свойств и методов](#3-объявление-констант-свойств-и-методов)
   * 3.1. [Последовательность объявлений констант, свойств и методов](#31-последовательность-объявлений-констант-свойств-и-методов)
   * 3.2. [Именование свойств](#32-именование-свойств)
   * 3.3. [Разделение свойств](#33-разделение-свойств)
   * 3.4. [Модификаторы доступа для свойств](#34-модификаторы-доступа-для-свойств)
   * 3.5. [Именование методов](#35-именование-методов)
   * 3.6. [Разделение методов](#36-разделение-методов)
   * 3.7. [Модификаторы доступа для методов](#37-модификаторы-доступа-для-методов)
   * 3.8. [Порядок аргументов в методе](#38-порядок-аргументов-в-методе)
   * 3.9. [Массив в виде аргумента](#39-массив-в-виде-аргумента)
4. [Безопасность](#4-безопасность)
   * 4.1. [Неявные приведения типов](#41-неявные-приведения-типов)
   * 4.2. [Сравнения с преобразованием типов](#42-сравнения-с-преобразованием-типов)
   * 4.3. [Инструкция switch](#43-инструкция-switch)
   * 4.4. [Присвоения в условных операциях](#44-присвоения-в-условных-операциях)
   * 4.5. [Ошибки](#45-ошибки)
   * 4.6. [Оператор управления ошибками @](#46-оператор-управления-ошибками-)
   * 4.7. [goto](#4.7.-goto)
   * 4.8. [eval](#4.8.-eval)
   * 4.9. [Глобальные переменные и global](#49-глобальные-переменные-и-global)
   * 4.10. [Статические свойства](#410-статические-свойства)
   * 4.11. [Суперглобальные переменные](#411-суперглобальные-переменные)
   * 4.12. [Динамическая подстановка имен](#412-динамическая-подстановка-имен)
   * 4.13. [Магические методы](#413-магические-методы)
   * 4.14. [Валидация аргументов](#414-валидация-аргументов)
   * 4.15. [\DateTime](#415-datetime)
   * 4.16. [Обработка часовых поясов](#416-обработка-часовых-поясов)
   * 4.17. [SQL](#417-sql)
5. [Принципы программирования](#5-принципы-программирования)
   * 5.1. [Здравый Смысл](#51-здравый-смысл)
   * 5.2. [YAGNI](#52-yagni)
   * 5.3. [SOLID](#53-solid)
   * 5.4. [DRY](#54-dryDRY)
   * 5.5. [KISS](#55-kiss)
   ...
   * 5.5. [GRASP](#55-grasp)
6. [Антишаблоны проектирования](#6-антишаблоны-проектирования)
   * 6.1. [ActiveRecord](#61-activerecord)
   * 6.2. [Singleton](#62-singleton)
7. [Тестирование](#7-тестирование)
   * 7.1. [Покрытие кода](#71-покрытие-кода)
   * 7.2. [Стратегия тестирования](#72-стратегия-тестирования)
   * 7.3. [Разделение тест методов](#73-разделение-тест-методов)
   * 7.4. [Тестируемый объект](#74-тестируемый-объект)
   * 7.5. [Проверка результатов](#75-проверка-результатов)
8. [PHPUnit](#8-phpunit)
   * 8.1. [Именование тестовых классов](#81-именование-тестовых-классов)
   * 8.2. [Именование тест методов](#82-именование-тест-методов)
   * 8.3. [Структура теста](#83-структура-теста)
   * 8.4. [Переменные, используемые в тесте](#84-переменные-используемые-в-тесте)
   * 8.5. [Mock-объекты](#85-mock-объекты)
   * 8.6. [Инкременты вызовов mock-объектов](#86-инкременты-вызовов-mock-объектов)
   * 8.7. [Поведение методов mock-объектов](#87-поведение-методов-mock-объектов)
   * 8.8. [Порядок утверждений для одного значения](#88-порядок-утверждений-для-одного-значения)
   * 8.9. [Проверка утверждений на основании результатов собственных проверок](#89-проверка-утверждений-на-основании-результатов-собственных-проверок)
   * 8.10. [Проверки значений на основании `TestCase::callback`](#810-проверки-значений-на-основании-testcasecallback`)
   * 8.11. [Проверка утверждений для числовых значений](#811-проверка-утверждений-для-числовых-значений)
   * 8.12. [Проверка утверждений для \DateTimeImmutable](#812-проверка-утверждений-для-datetimeimmutable)
9. [IDE](#9-ide)
   * 9.1. [Inspections и Code Style](#91-inspections-и-code-style)
...
### 8.4. Переменные, используемые в тесте
...
### 8.6. Инкременты вызовов mock-объектов
...
### 8.7. Поведение методов mock-объектов
...
### 8.8 Порядок утверждений для одного значения
...
### 8.9. Проверка утверждений на основании результатов собственных проверок
...
### 8.10. Проверки значений на основании `TestCase::callback`
...
### 8.11. Проверка утверждений для числовых значений
...
### 8.12. Проверка утверждений для \DateTimeImmutable
